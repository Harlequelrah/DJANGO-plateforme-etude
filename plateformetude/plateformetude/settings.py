"""
Django settings for plateformetude project.
...
SECRET_KEY = 'django-insecure-6t=%jjch!vx3pcfsa-m7#ktd@g1e2ps_wd_^8k83+y%=9unkfo'
...
ROOT_URLCONF = 'plateformetude.urls'
...
WSGI_APPLICATION = 'plateformetude.wsgi.application'
